...
/**
 * Class report_lessoncompletion_lib_testcase
 *
 * @package    report_lessoncompletion
 * @copyright  2014 onwards Ankit agarwal <ankit.agrr@gmail.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later.
 */
class report_lessoncompletion_lib_testcase extends advanced_testcase {
    ...
    public function test_report_participation_supports_logstore() {
        ...
        $stores = $logmanager->get_supported_logstores('report_lessoncompletion');
