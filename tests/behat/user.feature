...
Feature: View the user page for the lessoncompletion report
  In order to ensure the user page for the lessoncompletion report works as expected
  As a student
  I need to log in as a student and view the user page for the lessoncompletion report
  ...
  Scenario: View the user page when only the legacy log reader is enabled
    ...
    And I follow "URL name"
    And I follow "URL name"
    When I navigate to "lessoncompletion report" node in "My profile settings > Activity reports"
