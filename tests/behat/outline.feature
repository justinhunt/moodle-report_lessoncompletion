@report @report_lessoncompletion
Feature: View an lessoncompletion report
  In order to ensure the lessoncompletion report works as expected
  As a teacher
  I need to log in as a teacher and view the lessoncompletion report
  ...
  @javascript
  Scenario: View the lessoncompletion report when only the legacy log reader is enabled
  ...
  @javascript
  Scenario: View the lessoncompletion report when only the standard log reader is enabled
    Given I navigate to "Manage log stores" node in "Site administration > Plugins > Logging"
  ...
  @javascript
  Scenario: View the lessoncompletion report when both the standard and legacy log readers are enabled
    Given I navigate to "Manage log stores" node in "Site administration > Plugins > Logging"
    And I click on "Enable" "link" in the "Legacy log" "table_row"
    And "Disable" "link" should exist in the "Standard log" "table_row"
    And I set the following administration settings values:
  ...
  @javascript
  Scenario: View the lessoncompletion report when no log reader is enabled
    Given I navigate to "Manage log stores" node in "Site administration > Plugins > Logging"
    And "Enable" "link" should exist in the "Legacy log" "table_row"
    And I click on "Disable" "link" in the "Standard log" "table_row"
    And I follow "Home"
